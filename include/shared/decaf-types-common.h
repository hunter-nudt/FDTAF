...
#ifndef DECAF_TYPES_COMMON_H
#define DECAF_TYPES_COMMON_H
...
typedef int32_t decaf_target_long;
typedef uint32_t decaf_target_ulong;
#elif TARGET_LONG_SIZE == 8
typedef int64_t decaf_target_long;
typedef uint64_t decaf_target_ulong;
#else
# error TARGET_LONG_SIZE undefined
#endif

typedef decaf_target_ulong gva_t;
typedef decaf_target_ulong gpa_t;
