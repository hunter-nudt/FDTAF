...
public:
    ...
    unordered_map< fdtaf_target_ulong, module * >module_list;
    //a set of virtual pages that have been resolved with module information
    unordered_set< fdtaf_target_ulong > resolved_pages;
};
...
extern fdtaf_target_ulong vmi_guest_kernel_base;

// map pgd to process_info_t
extern unordered_map < fdtaf_target_ulong, process * > process_map;
// map pid to process_info_t
extern unordered_map < fdtaf_target_ulong, process * > process_pid_map;
