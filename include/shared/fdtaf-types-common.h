...
typedef int32_t fdtaf_target_long;
typedef uint32_t fdtaf_target_ulong;
#elif TARGET_LONG_SIZE == 8
typedef int64_t fdtaf_target_long;
typedef uint64_t fdtaf_target_ulong;
#else
# error TARGET_LONG_SIZE undefined
#endif

typedef fdtaf_target_ulong gva_t;
typedef fdtaf_target_ulong gpa_t;
