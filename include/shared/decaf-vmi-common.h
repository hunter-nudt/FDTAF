...
#ifndef DECAF_VMI_COMMON_H
#define DECAF_VMI_COMMON_H
...
public:
	...
	unordered_map < decaf_target_ulong, string> function_map_offset;
...
public:
    ...
    unordered_map < decaf_target_ulong,module * >module_list;
    //a set of virtual pages that have been resolved with module information
    unordered_set< decaf_target_ulong > resolved_pages;
    unordered_map< decaf_target_ulong, int > unresolved_pages;
};
...
extern uint32_t VMI_guest_kernel_base;

// map cr3 to process_info_t
extern unordered_map < decaf_target_ulong, process * > process_map;
// map pid to process_info_t
extern unordered_map < decaf_target_ulong, process * > process_pid_map;
...
// 以cr3或者pgd的值从容器process_map中查找相应process
