...
fdtaf_errno_t basic_callback_init(basic_callback_t* pList)
{
    if (pList == NULL)
    {
...
fdtaf_errno_t basic_callback_clear(basic_callback_t* pList)
{
...
fdtaf_errno_t basic_callback_delete(basic_callback_t* pList)
{
    if (pList == NULL)
    {
        return (NULL_POINTER_ERROR);
...
fdtaf_errno_t basic_callback_unregister(basic_callback_t* pList, fdtaf_handle handle)
{
